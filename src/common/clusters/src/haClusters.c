...
******************************************************************************/
void sendConfigureReportingToNotify(Endpoint_t endpoint, ClusterId_t clusterId, ZCL_AttributeId_t attrId, ZCL_ReportTime_t period)
{
  ZCL_Request_t *req;
  ...
  fillDstAddressing(&req->dstAddressing, APS_NO_ADDRESS, 0, endpoint, clusterId);
