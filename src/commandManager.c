...
typedef union PACK
{
  ...
  uint8_t        payload[sizeof(ZCL_AddScene_t) + sizeof(ZCL_OnOffClusterExtensionFieldSet_t) + sizeof(ZCL_LevelControlSceneExtensionFields_t)];
...
typedef union PACK
{
  ...
  uint8_t                 payload[sizeof(ZCL_ViewSceneResponse_t) + sizeof(ZCL_OnOffClusterExtensionFieldSet_t) + sizeof(ZCL_LevelControlSceneExtensionFields_t)];
                                  /* own structure size */          /* size of ext fields */
} ViewSceneResponse_t;

#define MAX_SCENES_AMOUNT 8
typedef union PACK
{
