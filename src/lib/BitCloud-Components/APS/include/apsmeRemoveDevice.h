/**************************************************************************//**
  ...
  \internal
   History:
    ...
    2012-02-04 Max Gekk - Support ZigBee Specification r20. It's possible
                          to remove any router from network by sending
                          APS Remove Device command from TC.
   Last change:
    $Id: apsmeRemoveDevice.h 25824 2013-12-10 08:44:12Z unithra.c $
 ******************************************************************************/
