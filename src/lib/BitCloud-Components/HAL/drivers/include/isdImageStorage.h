...
******************************************************************************/
int ISD_OpenTunnel(HAL_UsartDescriptor_t *descriptor);
...
******************************************************************************/
int ISD_CloseTunnel(HAL_UsartDescriptor_t *descriptor);
...
******************************************************************************/
int ISD_ReadTunnel(HAL_UsartDescriptor_t *descriptor, uint8_t *buffer, uint16_t length);
...
******************************************************************************/
int ISD_WriteTunnel(HAL_UsartDescriptor_t *descriptor, uint8_t *buffer, uint16_t length);
