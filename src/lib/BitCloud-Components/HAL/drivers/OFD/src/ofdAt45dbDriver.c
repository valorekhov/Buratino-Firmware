...
{
  sysAssert(ofdCallback, OFD_NULLCALLBACK10);
...
static void ofdReadImageTable(void)
{
  ...
  {
    sysAssert(ofdCallback, OFD_NULLCALLBACK11);
...
void ofdFindStorageSpace(void)
{
  ...
  sysAssert(ofdCallback, OFD_NULLCALLBACK12);
...
static void ofdSaveCrcCallback(void)
{
  sysAssert(ofdCallback, OFD_NULLCALLBACK13);
...
void ofdSaveImageTable(void)
{
  ...
  {
    sysAssert(ofdCallback, OFD_NULLCALLBACK14);
...
void ofdSaveCrc(void)
{
  ...
  {
    sysAssert(ofdCallback, OFD_NULLCALLBACK15);
    ((OFD_InfoCallback_t)ofdCallback)(OFD_STATUS_INCORRECT_EEPROM_PARAMETER, &imageInfo);
  }
}
...
void ofdReadCrc(void)
{
  ...
  {
    sysAssert(ofdCallback, OFD_NULLCALLBACK16);
    ((OFD_InfoCallback_t)ofdCallback)(OFD_STATUS_INCORRECT_EEPROM_PARAMETER, &imageInfo);
  }
}
