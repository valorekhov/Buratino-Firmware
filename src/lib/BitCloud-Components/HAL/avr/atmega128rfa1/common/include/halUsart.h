...
{
  sysAssert((USART_CHANNEL_0 == tty) || (USART_CHANNEL_1 == tty), HALUSARTH_HALCLOSEUSART_0);
  UCSRnB(tty) = 0x00;
}
...
{
  sysAssert((USART_CHANNEL_0 == tty) || (USART_CHANNEL_1 == tty), HALUSARTH_HALENABLEUSARTDREMINTERRUPT_0);
  UCSRnB(tty) |= (1 << UDRIE1);
}
...
{
  sysAssert((USART_CHANNEL_0 == tty) || (USART_CHANNEL_1 == tty), HALUSARTH_HALDISABLEUSARTDREMINTERRUPT_0);
  UCSRnB(tty) &= ~(1 << UDRIE1);
}
...
{
  sysAssert((USART_CHANNEL_0 == tty) || (USART_CHANNEL_1 == tty), HALUSARTH_HALENABLEUSARTTXCINTERRUPT_0);
  UCSRnB(tty) |= (1 << TXCIE1);
}
...
{
  sysAssert((USART_CHANNEL_0 == tty) || (USART_CHANNEL_1 == tty), HALUSARTH_HALDISABLEUSARTTXCINTERRUPT_0);
  UCSRnB(tty) &= ~(1 << TXCIE1);
}
...
{
  sysAssert((USART_CHANNEL_0 == tty) || (USART_CHANNEL_1 == tty), HALUSARTH_HALENABLEUSARTRXCINTERRUPT_0);
  UCSRnB(tty) |= (1 << RXCIE0);
}
...
{
  sysAssert((USART_CHANNEL_0 == tty) || (USART_CHANNEL_1 == tty), HALUSARTH_HALDISABLEUSARTRXCINTERRUPT_0);
  UCSRnB(tty) &= ~(1 << RXCIE0);
}
...
{
  sysAssert((USART_CHANNEL_0 == tty) || (USART_CHANNEL_1 == tty), HALUSARTH_HALSENDUSARTBYTE_0);
