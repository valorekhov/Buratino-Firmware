...
typedef struct
{
  ...
  void (*ZCL_DefaultRespInd)(ZCL_Addressing_t *addressing, uint8_t payloadLength, uint8_t *payload);
...
typedef struct
{
  ...
  void (*ZCL_Notify)(ZCL_Notify_t *ntfy);            //!< Callback function for response. Can be set to NULL.
...
\par Response statuses:
  ...
  ::ZCL_NO_RESPONSE_ERROR_STATUS (0xC3) - the response command is expected, but has not
