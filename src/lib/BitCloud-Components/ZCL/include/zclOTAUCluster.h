/**************************************************************************//**
  ...
  Last change:
    $Id: zclOTAUCluster.h 26388 2014-02-20 07:55:24Z yogesh.bellan $
*******************************************************************************/
...
#define DEFINE_OTAU_CLIENT_ATTRIBUTES \
        ...
        DEFINE_ATTRIBUTE(minimumBlockRequestDelay, ZCL_READONLY_ATTRIBUTE, ZCL_OTAU_CLUSTER_CLIENT_MINIMUM_BLOCK_REQUEST_DELAY_ID, ZCL_U16BIT_DATA_TYPE_ID)
