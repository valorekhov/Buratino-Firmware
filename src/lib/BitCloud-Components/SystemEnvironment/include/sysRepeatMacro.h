/************************************************************************//**
  \file sysRepeatMacro.h

  \brief Contains definition of repeat macro.
...
/**//** 
  ...
  *  
  * \param macro - macro to be repeated 
  *        Specified macro shall have two arguments: 
  *          macro(arg, i) 
  *            arg - user defined argument, which have the same value 
  *                  for all iterations.
  *            i - iteration number; numbering begins from zero and 
  *                increments on each iteration
  * \param arg - user defined argument for repeated macro 
  * \param n - total number of iterations (255 max)
  */
#define REPEAT_MACRO(macro, arg, n) REPEAT_MACRO_I(macro, arg, n)

// Second level is needed to get integer literal from "n"
// if it is defined as macro
#define REPEAT_MACRO_I(macro, arg, n) REPEAT##n(macro, arg, 0)

// Macro definitions for REPEAT_MACRO
